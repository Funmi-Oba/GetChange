<template lang="">
  <slot name="recent-activities">
    <div class="p-6">
      <div class="flex items-center justify-between">
        <h2 class="text-[#013C61] text-lg font-semibold">Recent Activities</h2>
        <div class="flex space-x-2">
          <p class="text-[#013C61] text-sm">
            <span class="border-[0.5px] border-[#013C61]/10 rounded-sm">1 </span> of 8
          </p>
